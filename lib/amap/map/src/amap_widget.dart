...
class AMapWidget extends StatefulWidget {
  ...
  const AMapWidget({
    ...
    this.gestureScaleByMapCenter = false,//新增，中心锁定缩放
    this.onMapCreated,
...
class _MapState extends State<AMapWidget> {
  ...
  void initState() {
    ...
    debugPrint('initState AMapWidget');
  }
  ...
  void dispose() async {
    ...
    controller.disponse();
    debugPrint('dispose AMapWidget with mapId: ${controller.mapId}');
  }

  @override
  void reassemble() {
    super.reassemble();
    debugPrint('reassemble AMapWidget');
  }

  @override
  void deactivate() async {
    super.deactivate();
    debugPrint('deactivate AMapWidget}');
  }
...
class _AMapOptions {
  ...
  Map<String, dynamic> toMap() {
    ...
    addIfNonNull('gestureScaleByMapCenter', gestureScaleByMapCenter);
