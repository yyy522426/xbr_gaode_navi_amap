...
import com.yilin.xbr.xbr_gaode_navi_amap.amap.core.AMapOptionsSink;
...
class AMapOptionsBuilder implements AMapOptionsSink {
    ...
    AMapPlatformView build(int id, Context context, BinaryMessenger binaryMessenger, LifecycleProvider lifecycleProvider) {
        try {
