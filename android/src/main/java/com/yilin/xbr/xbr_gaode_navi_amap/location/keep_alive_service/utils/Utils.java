...
public class Utils {
    ...
    private static final String CLOSE_BRODECAST_INTENT_ACTION_NAME = "com.yilin.xbr.xbr_gaode_location.CloseService";
    private static NotificationManager mNotificationManager;
    private static SimpleDateFormat sdf = null;
    private static String title = "定位服务运行中";
    private static String text = "程序正在后台采集定位信息";
    /**
     * 根据定位结果返回定位信息的字符串
     */
    ...
    public static Notification buildNotification(Context context) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            ...
            Notification.Builder builder = new Notification.Builder(context,
                    ...
                    .setContentText(text)
                    .setSmallIcon(R.mipmap.lieyin)
                    .setAutoCancel(true);
            notification = builder.build();
        } else {
            Notification.Builder builder = new Notification.Builder(context);
            builder.setSmallIcon(R.mipmap.lieyin);
