...
import com.yilin.xbr.xbr_gaode_navi_amap.amap.core.MapController;
import com.yilin.xbr.xbr_gaode_navi_amap.amap.overlays.marker.MarkersController;
import com.yilin.xbr.xbr_gaode_navi_amap.amap.overlays.polygon.PolygonsController;
import com.yilin.xbr.xbr_gaode_navi_amap.amap.overlays.polyline.PolylinesController;
...
public class AMapPlatformView implements DefaultLifecycleObserver, ActivityPluginBinding.OnSaveInstanceStateListener, MethodChannel.MethodCallHandler, PlatformView {
    ...
    AMapPlatformView(int id, Context context, BinaryMessenger binaryMessenger, LifecycleProvider lifecycleProvider, AMapOptions options) {
        methodChannel = new MethodChannel(binaryMessenger, "xbr_amap_" + id);
    ...
    public void onCreate(@NonNull LifecycleOwner owner) {
        ...
        try {
            if (disposed) return;
            if (null != mapView) mapView.onCreate(null);
        } catch (Throwable e) {
